...
class YacclabTensorInput2DCuda : public YacclabTensorInput2D {
 ...
 public:
  virtual void Create() override {
    YacclabTensorInput2D::Create();
    d_mat_.upload(mat_);
  }
  virtual void Release() override {
    YacclabTensorInput2D::Release();
    d_mat_.release();
  }
  virtual bool ReadBinary(const std::string& filename) override;
...
class YacclabTensorInput3DCuda : public YacclabTensorInput3D {
 ...
 public:
  virtual void Create() override {
    YacclabTensorInput3D::Create();
    d_mat_.upload(mat_);
  }
  virtual void Release() override {
    YacclabTensorInput3D::Release();
    d_mat_.release();
  }
  virtual bool ReadBinary(const std::string& filename) override;
  virtual cv::Mat& GetMat() override { return mat_; }
...
class YacclabTensorOutput2D : public YacclabTensorOutput {
 ...
 public:
  ...
  virtual std::unique_ptr<YacclabTensorOutput> Copy() const override {
    return std::make_unique<YacclabTensorOutput2D>(mat_);
  }
};
...
class YacclabTensorOutput3D : public YacclabTensorOutput {
 ...
 public:
  ...
  virtual cv::Mat& Raw() { return mat_; }
  virtual std::unique_ptr<YacclabTensorOutput> Copy() const override {
    return std::make_unique<YacclabTensorOutput3D>(mat_);
  }
};
...
class YacclabTensorOutput2DCuda : public YacclabTensorOutput2D {
 ...
 public:
  virtual void PrepareForCheck() override {
    d_mat_.download(YacclabTensorOutput2D::mat_);
  }
  virtual void Release() override {
    YacclabTensorOutput2D::Release();
    d_mat_.release();
  }
  virtual const cv::Mat& GetMat() override {
    return YacclabTensorOutput2D::mat_;
  }
  virtual cv::cuda::GpuMat& GpuRaw() { return d_mat_; }
};
...
class YacclabTensorOutput3DCuda : public YacclabTensorOutput3D {
 ...
 public:
  virtual void PrepareForCheck() override {
    d_mat_.download(YacclabTensorOutput3D::mat_);
  }
  virtual void Release() override {
    YacclabTensorOutput3D::Release();
    d_mat_.release();
  }
  virtual const cv::Mat& GetMat() override {
    return YacclabTensorOutput3D::mat_;
  }
  virtual cv::cuda::GpuMat3& GpuRaw() { return d_mat_; }
};
#endif
